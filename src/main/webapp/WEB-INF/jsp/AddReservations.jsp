    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="border rounded p-4">
                ...
                <!-- Reservation form -->
                <form action="AddReservations" method="POST" modelAttribute="reservation" id="reservationForm" >
                    <!-- Reservation details -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" path="mileage" id="mileage" name="mileage" required min="0" max="1000000" maxlength="7">
                    </div>
                    <div class="form-group">
